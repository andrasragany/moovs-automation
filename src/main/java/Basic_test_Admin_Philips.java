...
public class Basic_test_Admin_Philips extends Thread{
    private WebDriver driver;
    private WebDriverWait waiter;
    private String browsertype;

    public Basic_test_Admin_Philips(String name, String browsertype) {
        super(name);
    ...
    public void student() throws Exception {
        ...
        _fc.login(logger, driver, waiter, "philipsadmin", "philipsadminpassword");
    ...
    public static void main(String[] argv) throws Exception {
        Thread ChromeThread = new Basic_test_Admin_Philips("Thread Chrome", "Chrome");
        Thread FireFoxThread = new Basic_test_Admin_Philips("Thread FireFox", "Firefox");
        Thread OperaThread = new Basic_test_Admin_Philips("Thread Opera", "Opera");
        Thread EdgeThread = new Basic_test_Admin_Philips("Thread Edge", "Edge");
