...
public class Basic_test_Admin_Bissell {
        ...
        private static void navigatetoprofile(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(1000);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_user_dropdown))).click();
            Thread.sleep(1000);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_profile))).click();
            Thread.sleep(500);
        ...
        private static void navigatetousergroups(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            ...
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_user_groups))).click();
            Thread.sleep(100);
        ...
        static String createstudentusergroup(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException, ParseException {
            ...
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_usergroup_add_user))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_usergroup_save))).click();
            Thread.sleep(100);
            webDriver.navigate().refresh();
            Thread.sleep(100);
        ...
        private static void editprofile(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            ...
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_profile_edit_button))).click();
            Thread.sleep(100);
        ...
        private static void changepreferreddevicetotablet(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_preferred_device_dropdown))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_preferred_device_totablet))).click();
            Thread.sleep(100);
        ...
        private static void changepreferreddevicetosmartphone(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            ...
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_preferred_device_dropdown))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_preferred_device_tosmatphone))).click();
            Thread.sleep(100);
        ...
        private static void saveprofile(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_profile_edit_Save))).click();
            Thread.sleep(100);
        ...
        static void navigatetocommunication(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_communication))).click();
            Thread.sleep(100);
        ...
        private static void deletecommunication(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            ...
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_search_input_searchbtn))).click();
            Thread.sleep(200);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_search_result_sort_dropdown))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_result_list_sort_descending_date))).click();
            Thread.sleep(200);
            for (int j=1; j<6; j++){
        ...
        private static void createcommunication(Logger logger, WebDriver webDriver, WebDriverWait wait, String groupname) throws InterruptedException {
            ...
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_check_news))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_search_group))).sendKeys(groupname);
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_select_first_group))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_add_group_btn))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_check_now))).click();
            Thread.sleep(100);
            ((JavascriptExecutor) webDriver).executeScript("window.scrollTo(0, document.body.scrollHeight)");
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_save))).click();
        ...
        private static boolean checkcommunicationispublished(Logger logger, WebDriver webDriver, WebDriverWait wait, String communicationname) throws InterruptedException {
            ...
            if (webDriver.findElement((By.xpath("/html/body/div[2]/div/div/div/div[1]/h1"))).getText().contains(communicationname)) {
                wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.Selector_admin_dashboard_closecomm_modal))).click();
        ...
        private static void navigatetomodules(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_modules))).click();
            Thread.sleep(200);
        ...
        private static void navigate_to_translate (Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_modules_first_action_dropdown))).click();
            Thread.sleep(200);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_modules_first_dropdown_translate))).click();
            Thread.sleep(200);
        ...
        private static void navigatetomoduledetails (Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            webDriver.navigate().refresh();
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_module_translate_module_details))).click();
            Thread.sleep(200);
        ...
        private static void change_first_translation_and_save (Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            ...
            ((JavascriptExecutor) webDriver).executeScript("window.scrollTo(0, document.body.scrollHeight)");
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_translate_changed_save ))).click();
            Thread.sleep(200);
        ...
        private static void deletecreatedcommunication(Logger logger, WebDriver webDriver, WebDriverWait wait, String communicationname) throws  InterruptedException {
            ...
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_search_input_searchbtn))).click();
            Thread.sleep(200);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_trainer_comm_found_list_first_action_dropdown))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_found_list_first_action_deletebtn))).click();
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_comm_action_delete_confirm))).click();
        ...
        private static void navigatetocontacts(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_contact))).click();
            Thread.sleep(100);
        ...
        private static void navigatetodashboard(Logger logger, WebDriver webDriver, WebDriverWait wait) throws InterruptedException {
            Thread.sleep(100);
            wait.until(elementToBeClickable(By.xpath(Object_repo_Bissell.selector_admin_dashboard))).click();
            Thread.sleep(100);
