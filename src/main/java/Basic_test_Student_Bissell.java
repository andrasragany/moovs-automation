...
public class Basic_test_Student_Bissell extends Thread{
    private WebDriver driver;
    private WebDriverWait waiter;
    private String browsertype;

    public Basic_test_Student_Bissell(String name, String browsertype) {
        super(name);
    ...
    public void student() throws Exception {
        ...
        _fc.login(logger, driver, waiter, "bissellstudent", "bissellstudentpassword");
    ...
    public static void main(String[] argv) throws Exception {
        Thread ChromeThread = new Basic_test_Student_Bissell("Thread Chrome", "Chrome");
        Thread FireFoxThread = new Basic_test_Student_Bissell("Thread FireFox", "Firefox");
        Thread OperaThread = new Basic_test_Student_Bissell("Thread Opera", "Opera");
        Thread EdgeThread = new Basic_test_Student_Bissell("Thread Opera", "Edge");
