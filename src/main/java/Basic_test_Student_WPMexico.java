...
public class Basic_test_Student_WPMexico {
    public static void main(String[] argv) throws Exception {
        ...
        //Login
        _fc.login(logger, webDriver, wait, "wpmexstudent", "wpmexstudentpassword");
        _fc.login(logger, ffDriver, wait_ff, "wpmexstudent", "wpmexstudentpassword");
        _fc.login(logger, opDriver, wait_op, "wpmexstudent", "wpmexstudentpassword");
