...
public class Basic_test_Admin_WLearn extends Thread{
    private WebDriver driver;
    private WebDriverWait waiter;
    private String browsertype;

    public Basic_test_Admin_WLearn(String name, String browsertype) {
        super(name);
    ...
    public void student() throws Exception {
        ...
        _fc.login_WL(logger, driver, waiter, "wlearnadmin", "wlearnadminpassword");
    ...
    public static void main(String[] argv) throws Exception {
        Thread ChromeThread = new Basic_test_Admin_WLearn("Thread Chrome", "Chrome");
        Thread FireFoxThread = new Basic_test_Admin_WLearn("Thread FireFox", "Firefox");
        Thread OperaThread = new Basic_test_Admin_WLearn("Thread Opera", "Opera");
        Thread EdgeThread = new Basic_test_Admin_WLearn("Thread Opera", "Edge");
