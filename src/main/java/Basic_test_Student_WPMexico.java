...
public class Basic_test_Student_WPMexico extends Thread{
    private WebDriver driver;
    private WebDriverWait waiter;
    private String browsertype;

    public Basic_test_Student_WPMexico(String name, String browsertype) {
        super(name);
    ...
    public void student() throws Exception {
        ...
        _fc.gotourl(logger,driver,"https://www.campuswhirlpool.com/login");
        _fc.login(logger, driver, waiter, "wpmexstudent", "wpmexstudentpassword");
        _fc.navigatetoprofile(logger, driver, "https://www.campuswhirlpool.com/profile");
    ...
    public static void main(String[] argv) throws Exception {
        Thread ChromeThread = new Basic_test_Student_WPMexico("Thread Chrome", "Chrome");
        Thread FireFoxThread = new Basic_test_Student_WPMexico("Thread FireFox", "Firefox");
        Thread OperaThread = new Basic_test_Student_WPMexico("Thread Opera", "Opera");
        Thread EdgeThread = new Basic_test_Student_WPMexico("Thread Opera", "Edge");
