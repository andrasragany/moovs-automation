...
public class Basic_test_Admin_Bissell {
    ...
    private static boolean faszaklikk(WebDriver webDriver, Logger logger, String webElement, WebDriverWait wait, String what) throws InterruptedException, TimeoutException {
        ...
        private static void navigatetocontacts(Logger logger, WebDriver webDriver, WebDriverWait wait, String user) throws InterruptedException {
            Thread.sleep(100);
            switch (user) {
                case "admin": faszaklikk(webDriver, logger, Object_repo_Philips.selector_admin_contact_Bissell, wait, "selector_admin_contact");
                break;
                case "trainer": faszaklikk(webDriver, logger, Object_repo_Philips.selector_trainer_contact, wait, "selector_trainer_contact");
                break;
            }
            Thread.sleep(100);
        ...
        public static void main(String[] argv) throws Exception {
            ...
            faszaklikk(webDriver, logger, Object_repo_Philips.selector_admin_training_lib_trainer_Bissell, wait, "selector_admin_training_lib_trainer");
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_admin_training_lib_trainer_Bissell, wait_ff, "selector_admin_training_lib_trainer");

            webDriver.navigate().refresh();
            ffDriver.navigate().refresh();

            Thread.sleep(100);
            faszaklikk(webDriver, logger, Object_repo_Philips.selector_trainer_create_training_btn, wait, "selector_trainer_create_training_btn");
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_training_btn, wait_ff, "selector_trainer_create_training_btn");
            ...
            if (faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_training_add_name, wait_ff, "selector_trainer_training_add_name"))
            ...
            if (faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_training_add_description, wait_ff, "selector_trainer_training_add_description"))
                ffDriver.findElement(By.xpath(Object_repo_Philips.selector_trainer_training_add_description)).sendKeys(userGroupNameFF2);

            faszaklikk(webDriver, logger, Object_repo_Philips.selector_trainer_create_training_modules_tab, wait, "selector_trainer_create_training_modules_tab");
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_training_modules_tab, wait_ff, "selector_trainer_create_training_modules_tab");
            ...
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_training_add_module_btn, wait_ff, "selector_trainer_create_training_add_module_btn");
            ...
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_tr_add_mod_checkbox, wait_ff, "selector_trainer_create_tr_add_mod_checkbox");
            ...
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_tr_add_selected_module_btn, wait_ff, "selector_trainer_create_tr_add_selected_module_btn");
            ...
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_create_tr_exam_tab, wait_ff, "selector_trainer_create_tr_exam_tab");

            faszaklikk(webDriver, logger, Object_repo_Philips.selector_trainer_save_training_btn, wait, "selector_trainer_save_training_btn");
            faszaklikk(ffDriver, logger, Object_repo_Philips.selector_trainer_save_training_btn, wait_ff, "selector_trainer_save_training_btn");
