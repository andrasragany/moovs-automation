...
public class Basic_test_Admin_Fiskars {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        _fc.gotourl(logger, opDriver, "https://test.fiskarsacademy.com/login");
        ...
        _fc.login(logger, opDriver, wait_op, "fiskarsadmin", "fiskarsadminpassword");
        ...
        _fc.navigatetoprofile(logger, opDriver, "https://test.fiskarsacademy.com/profile");
        ...
        String userGroupNameChrome1 = _fc.create_usergroup(logger, webDriver, wait, "Student");
        String userGroupNameFF1 = _fc.create_usergroup(logger, ffDriver, wait_ff, "Student");
        String userGroupNameOP1 = _fc.create_usergroup(logger, opDriver, wait_op, "Quince Student");

        _fc.navigatetousergroups(logger, webDriver, wait, "admin");
        _fc.navigatetousergroups(logger, ffDriver, wait_ff, "admin");
        _fc.navigatetousergroups(logger, opDriver, wait_op, "admin");
        String userGroupNameChrome2 = _fc.create_usergroup(logger, webDriver, wait, "Student");
        String userGroupNameFF2 = _fc.create_usergroup(logger, ffDriver, wait_ff, "Student");
